...
INSERT INTO `addresses` VALUES (1,'123 Fake St',NULL,'Frisco','Texas','United States','75080'),(2,'1234555 Hello St','','Sachse','Texas','United States','75048'),(3,'100 Rock St',NULL,'Fort Worth','Texas','United States','76123'),(4,'1212 Heritage Blvd',NULL,'Allen','Texas','United States','75081'),(5,'1010 Summer St','Apt 102','McKinney','Texas','United States','75023'),(6,'sdfjkl;sdfa','sdfa','sdfa','Alabama','United States','sdfa'),(7,'sdfjkl;sdfa','sdfa','sdfa','Alabama','United States','sdfa'),(8,'afds',NULL,'asdf','Alabama','United States','45612');
...
INSERT INTO `users` VALUES (32,'admin','$2a$10$jX1vc6f2iIePuQP80S3H.OA9uWFlyjM1aZl1Qt4dThcZujtTsXCvu','Admin','Admin','admin@gmail.com','LOCAL',2,'http://res.cloudinary.com/dwnb2nqcu/image/upload/v1663352337/up5wqdu71duwlur9fduc.png'),(33,'boss','$2a$10$ERIORYKMjnrX8KEmabKVxuTmiK3k44oAP7saio8XAmrEKka7x49oi','Boss','Boss','boss@gmail.com','LOCAL',1,NULL),(49,'user','$2a$10$h8kqjRSZ6rw/KF2RjU3lCOA7VY8nHFUzrvufJ1TplPSGvae8NNoDy','User','User','user@gmail.com','LOCAL',5,NULL),(50,'tyler','$2a$10$/r5C9Ol5dRHolfjpJMlOTOJO/orVRjEAWZTFhv/MvnVLJl6r9OSly','Tyler','Tyhlker','werwer@gmail.com','LOCAL',3,NULL),(52,'test222','$2a$10$oBUYEJnscbtjwDxXirDF5u8ZQql6Fm4azu8d2IP1abBdYCcmyUduC','Test','Test','test22@gmail.com','LOCAL',4,NULL),(57,'alicetest@gmail.com','$2a$10$xbYv8bM201Sr86.HvMPDY.TxG7c/azN9sLWo4FfJLY.VYHth4pQ6e','Alice','Test','alicetest@gmail.com','OKTA',2,NULL),(58,'huong.nguyen@hcl.com','$2a$10$UlCBexMRg.qW6LlV2fju0u/xq3JKNib4GX1IALqGJ1gln8jzcAG6u','Alice Huong','Nguyen','huong.nguyen@hcl.com','OKTA',1,NULL),(60,'testnewuser','$2a$10$azXcVuQK76LdqYQLyzv3UepflSFRAgnNPUk23Lqp3sADKQUoXQKc6','Test New','Hello','test@gmail.com','LOCAL',2,NULL),(61,'d','$2a$10$dyf8E6yLRkB7Kr2hf1v.Oe2HqDIY3rzhqfJnabDk3ogmZP4Tb4212','d','d','d@gmail.com','LOCAL',3,NULL),(64,'testuser2','$2a$10$Ru2b9uzcbrMHgkujAhW76OU.oP2grN24mjX6.wtfCg459Qe.G6lCO','Test','UserTest','test223@gmail.com','LOCAL',2,NULL),(71,'SJH','$2a$10$ftuFRAZ5kOADvZvmKTdAEu.N664BnEP4tqrKkEqxbo4y5T2mSzFLa','Samuel','Hobbs','samuel@email.com','LOCAL',8,NULL);
...
-- Dump completed on 2022-09-16 14:00:53
