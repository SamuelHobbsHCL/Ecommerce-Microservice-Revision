...
INSERT INTO `products` VALUES (1,'iPhone 13 - 512 GB',1129.00,25,'product1.png','A lightning‑fast chip. A leap in battery life. And all‑new photo and video capabilities.'),(2,'Macbook Pro 16\"',2772.99,18,'product2.jpg','With the blazing-fast M1 Pro or M1 Max chip — the first Apple silicon designed for pros'),(3,'Sony Playstation 5',649.00,22,'product3.jpg','Experience lightning-fast loading with an ultra-high speed SSD, deeper immersion with support for haptic feedback.'),(4,'Sony WF-1000XM4',229.99,39,'product4.jpg','WF-1000XM4 earphones combine our most advanced noise cancelling with exceptional audio performance'),(5,'Samsung - 55\" Odyssey',3499.99,39,'product5.jpg','55 inch, 1000R curved 4K UHD monitor with an exceptional picture quality via Quantum Mini-LED'),(6,'Samsung Galaxy Watch 5',449.99,46,'product6.jpg','Worry less and do more and with a Sapphire Crystal Glass that’s more durable than before and a water resistant design that can take a splash⁴ or two. Go ahead, unleash the best you with Galaxy Watch5.'),(7,'Xbox Series X',629.00,48,'product7.jpeg','Xbox Series X is the fastest, most powerful Xbox yet. Xbox Series S offers next-gen performance in the smallest Xbox ever.'),(8,'Nintendo Switch OLED',333.33,45,'product8.jpeg','Nintendo Switch OLED');
